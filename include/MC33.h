...
#define GRD_type_size 8 // 1, 2, 4 or 8 (8 for double, if not defined integer_GRD)
#endif
#ifndef MC33_double_precision
#define MC33_double_precision 1 // 1 means double type for MC33 class members, used only with double or size 4 integer grid data
#endif
